...
sim.busses[1].models[0].h = torch.tensor(np.random.uniform(0.5 * 6, 2.0 * 6, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
...
sim.busses[2].models[0].h = torch.tensor(np.random.uniform(0.5 * 4.9, 2.0 * 4.9, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[2].models[0].x_d = torch.tensor(np.random.uniform(0.5 * 1.81, 2.0 * 1.81, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[2].models[0].x_q = torch.tensor(np.random.uniform(0.5 * 1.76, 2.0 * 1.76, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[2].models[0].x_d_t = torch.tensor(np.random.uniform(0.5 * 0.3, 2.0 * 0.3, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[2].models[0].x_q_t = torch.tensor(np.random.uniform(0.5 * 0.65, 2.0 * 0.65, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)


sim.busses[3].models[0].h = torch.tensor(np.random.uniform(0.5 * 4.1, 2.0 * 4.9, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[3].models[0].x_d = torch.tensor(np.random.uniform(0.5 * 1.81, 2.0 * 1.81, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[3].models[0].x_q = torch.tensor(np.random.uniform(0.5 * 1.76, 2.0 * 1.76, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[3].models[0].x_d_t = torch.tensor(np.random.uniform(0.5 * 0.3, 2.0 * 0.3, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[3].models[0].x_q_t = torch.tensor(np.random.uniform(0.5 * 0.65, 2.0 * 0.65, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)

sim.busses[4].models[0].h = torch.tensor(np.random.uniform(0.5 * 3.2, 2.0 * 4.9, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[4].models[0].x_d = torch.tensor(np.random.uniform(0.5 * 1.81, 2.0 * 1.81, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[4].models[0].x_q = torch.tensor(np.random.uniform(0.5 * 1.76, 2.0 * 1.76, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[4].models[0].x_d_t = torch.tensor(np.random.uniform(0.5 * 0.3, 2.0 * 0.3, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
sim.busses[4].models[0].x_q_t = torch.tensor(np.random.uniform(0.5 * 0.65, 2.0 * 0.65, (parallel_sims, 1)), requires_grad=True, dtype=torch.complex128)
