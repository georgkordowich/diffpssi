...
from power_sim_lib.simulator import PowerSystemSimulation
...
sim.busses[1].models[0].h = torch.tensor(np.random.uniform(0.5 * 6, 2.0 * 6, (parallel_sims, 1)), requires_grad=True,
